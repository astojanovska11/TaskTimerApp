...
public class DurationsReport extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>,
    ...
    protected void onPostCreate(@Nullable Bundle savedInstanceState) {
        ...
        savedInstanceState.putLong(CURRENT_DATE, mCalendar.getTimeInMillis());
        savedInstanceState.putBoolean(DISPLAY_WEEK, mDisplayWeek);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id) {
            ...
            case R.id.rm_filter_date:
                 showDatePickerDialog("Pick a date", DIALOG_FILTER); // The actual filtering is done in onDateSet();
                return true;
            case R.id.rm_delete:
               showDatePickerDialog("Select date to delete up to ", DIALOG_DELETE); // The actual deleting is done in onDateSet();
                return true;
        }
...
private void showDatePickerDialog(String title, int dialogId){
    ...
    Log.d(TAG, "ShowDatePickerDialog: Exiting datePickerDialog()");
}
    ...
    private void deleteRecords(long timeInMillis){
        Log.d(TAG, "deleteRecords: Entering deleteRecords()");
        ...
        applyFilter();
        getSupportLoaderManager().restartLoader(LOADER_ID, mArgs, this);
        Log.d(TAG, "deleteRecords: Exiting deleteRecords()");
    }
    @Override
    public void onPositiveDialogResult(int dialogId, Bundle args) {
        ...
        //re-query, in case we've deleted records that are currently showing
        getSupportLoaderManager().restartLoader(LOADER_ID, mArgs, this);
    }
