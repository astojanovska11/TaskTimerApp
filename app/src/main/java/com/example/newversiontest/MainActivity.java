...
import com.example.newversiontest.debug.TestData;

public class MainActivity extends AppCompatActivity implements CursorRecyclerViewAdapter.OnTaskClickListener,
        SecondFragment.OnSaveClicked,
...
//                Log.d(TAG, "onClick: Entering messageView.onClick, showing = " + mDialog.isShowing());
    ...
    public void onBackPressed() {
        ...
        FragmentManager fragmentManager = getSupportFragmentManager();
        SecondFragment fragment = (SecondFragment) fragmentManager.findFragmentById(R.id.task_details_container);
